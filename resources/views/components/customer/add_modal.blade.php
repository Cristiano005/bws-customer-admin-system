            ...
            <div class="modal-body">
                <form method="POST" id="createCustomerForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="birthday_date" placeholder="Data de nascimento" id="birthday_date" required>
                    </div>
                    <label for="income" class="form-label">Renda familiar</label>
                    <input type="number" class="form-control" name="income" placeholder="Renda Familiar" id="income"  min="0"
